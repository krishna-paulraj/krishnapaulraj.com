/* eslint-disable react-hooks/refs --
   Vendored from the Aceternity registry as-is. Upstream mirrors the latest
   props into a ref during render so the long-lived rAF loop reads fresh
   values without re-running the WebGL setup effect; rewriting that here
   would fork the component and complicate future registry pulls. */
"use client";
