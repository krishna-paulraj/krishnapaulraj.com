/* eslint-disable react-hooks/set-state-in-effect, react-hooks/refs, react-hooks/exhaustive-deps --
   Vendored from the ReUI registry as-is. Upstream synchronizes controlled
   state in effects, which this repo's stricter hooks rules reject; fixing
   that here would fork the component and complicate future registry pulls. */
"use client";
"use no memo";
